...
public class SubCip {
	...
	private static char[][] generateTable() {
		// Shuffle the plain array
		Collections.shuffle(Arrays.asList(plain));
	...
	// Part 2 concised into one code I felt only two methods were neccesary for it
	// instead of a whole class

	public static void Attack(char[][] table, String key) throws FileNotFoundException {
		File file = new File("C:/Users/Pinkn/SubCipher/SubCipher-1/plain.txt");
	...
	public static void Guesser() {
		...
		while (choice != 2) {
			...
			System.out.println("Changed attempt: " + attempt);
